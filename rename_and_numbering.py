...
# prompts user to say what to replace:
REPLACE = str(input('Please enter the part you want to have replaced exactly as it appears in the filename: '))
WITH = ''
...
def main():
    ...
    # in my case this is the date of modification (i.e. acquiisition) to make sure the loop files are in the correct order
...
def copy_and_rename_them(filenames, root_path, result_path):
    ...
    for filename in filenames:
        ...
        output_file = os.path.join(result_path, new_filename + "pos" + str(pos_num) + ".obf")
        print(input_file)
        print(output_file)
